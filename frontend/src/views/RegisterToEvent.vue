...
export default {
  ...
  methods: {
    getRegistrations() {
      return axios({
        method: "get",
        url: "//localhost:4040/api/registration/getAllRegistrations",
        headers: {
    ...
    getAllCountries() {
      return axios({
        method: "get",
        url: "//localhost:4040/api/registration/getAllCountries",
        headers: {
          "auth-token": this.jwtToken,
        },
        data: {},
    ...
    register() {
      ...
      APIPayload.eventName = this.registerAPIcall.eventName.eventName
      ...
      if(this.companyPresent === "No") {
        APIPayload.companyName = this.companyNameNew
      }
      if(this.companyPresent === "Yes") {
        APIPayload.companyName = this.registerAPIcall.companyName.name
      }
      ...
      APIPayload.exportMarkets = ExportMarkets
      APIPayload.activityAreas = Activities
      ...
      return axios({
        method: "post",
        url: "//localhost:4040/api/registration/make",
        headers: {
          "auth-token": this.jwtToken
          },
        data: APIPayload,
